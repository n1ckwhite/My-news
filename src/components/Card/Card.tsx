...
export const Card: FC<IProps> = ({ key, card }) => {
  return (
    <li key={key} className={stylesCard.li}>
      <a className={stylesCard.link} href={card.url} target="_blank" rel="noreferrer">
        <img className={stylesCard.img}
          src={
